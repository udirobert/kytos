"""Modal k028 job: consensus + dual-moment (pk12, b0p3) submission .vcc.

Identical pipeline to k027; the generator config is the round-5 Gate B
winner: build_prediction_dual_moment(amplitude=1.0, bulk_amplitude=0.3,
pool_k=12). Arm metrics embargoed
(experiments/_embargoed/k025-eval2-gate/).

Run:
  modal run -d tools/modal_k028_dm_pk12_submit.py::build_and_prep
  modal run -d tools/modal_k028_dm_pk12_submit.py::submit_from_volume

Persists to /kytos-vol/k028-consensus-dm-pk12/.
"""
...
app = modal.App("kytos-k028-consensus-dm-pk12")
...
OUT_DIR = "/root/kytos/experiments/k028-consensus-dm-pk12"
DELTAS_VOL = (
    "/kytos-vol/k023-consensus/extract-20260921-02-honest/variants/variant_consensus_w_ctr.npz"
)
TAG = "k028-consensus-dm-pk12"
MODEL_NAME = "kytos-k028-consensus-dm-pk12"
