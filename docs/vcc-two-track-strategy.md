...
Platform: rented GPU with persistent disk (Vast.ai / RunPod, ≥24 GB VRAM,
≥32 GB system RAM) — not Modal, because training iteration needs
persistent checkpoints and interactive debugging across hours-days.
